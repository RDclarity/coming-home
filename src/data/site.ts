...
export const hero = {
  ...
  modalities:
    'Breathwork · Holistic Bodywork · Prozessbegleitung · 1:1 Begleitung · Gruppenarbeit · Workshops · Retreats',
  ...
  cards: [
    {
      ...
      offers: 'Workshops · Gruppen-Breathwork · Community Events',
    },
    {
      num: '02',
      label: 'Vertiefen',
      ...
      offers: '1:1 Breathwork · Holistic Bodywork · individuelle Sessions',
    },
    {
      num: '03',
      ...
      offers: '12-Wochen-Begleitung · intensive Begleitung · Integration',
    },
  ],
  ...
  steps: [
    {
      ...
      text: 'Vielleicht spürst du schon lange, dass da mehr in dir steckt. Mehr Verbindung. Mehr Lebendigkeit. Mehr von dem, was sich wirklich nach dir anfühlt. In meinen Workshops und Tagesformaten lernst du meine Arbeit kennen, sammelst erste Erfahrungen und beginnst, deinem Körper und deiner inneren Stimme wieder zuzuhören.',
      offers: [
        'Feminine Power – Tagesworkshop',
        'Coming Home Workshop',
        'thematische Tagesformate',
        'besondere Community Events',
      ],
      cta: { label: 'Workshops entdecken', href: '/#termine' },
    },
    {
      num: '02',
      keyword: 'Erleben',
      title: 'Gemeinsam atmen. Gemeinsam fühlen. Gemeinsam wachsen.',
      text: 'Manche Erfahrungen entfalten ihre größte Kraft, wenn wir sie miteinander teilen. In der Gruppe entstehen Verbindung, Vertrauen und das Gefühl, nicht allein zu sein.',
      offers: ['Breathwork Gruppensessions', 'Kakao und Breathwork', 'Community Circles'],
      cta: { label: 'Gruppentermine ansehen', href: '/#termine' },
    },
    {
      num: '03',
      keyword: 'Vertiefen',
      ...
      offers: [
        'Holistic Bodywork',
        'Breathwork',
        'Cranio und achtsame Körperbegleitung',
        'Kundalini Awakening',
        'persönliches Mentoring',
      ],
      cta: { label: '1:1 Begleitung entdecken', href: '/#kennenlernen' },
    },
    {
      num: '04',
      keyword: 'Verkörpern',
    ...
    },
    {
      num: '05',
      keyword: 'Eintauchen',
      title: 'Raus aus dem Alltag. Rein in die Tiefe.',
      text: 'Manchmal braucht Veränderung Abstand vom Gewohnten. Retreats schenken dir Zeit, Ruhe und den Raum, ganz bei dir anzukommen und neue Erfahrungen nachhaltig zu integrieren, außerhalb des Gewohnten. Ein Raum für Körperarbeit, Atem, Bewegung, Verbindung, Stille, Natur und Integration.',
      offers: ['Coming Home Retreats'],
      cta: { label: 'Für Retreat-Informationen vormerken', href: '/#kontakt' },
    },
    {
      num: '06',
      keyword: 'Weitergeben',
...
export const faq = {
  ...
  items: [
    ...
    },
    {
      ...
      a: 'Eine Einzelsession (Breathwork, Bodywork, Cranio-Sacral, Kundalini oder Prozessbegleitung) kostet 140 € für 90 Minuten. Der Tagesworkshop „Feminine Power" kostet 369 € pro Person. Die dreimonatige Coming-Home-Begleitung liegt bei 2.990 € gesamt, die Jahresbegleitung bei 9.590 € gesamt. Im kostenlosen Kennenlerngespräch schauen wir gemeinsam, welcher Rahmen zu dir passt.',
    },
    {
      slug: 'wo-finden-sessions-statt',
      q: 'Wo finden die Sessions statt?',
      a: '1:1 Sessions finden in Niederösterreich statt, Gruppenformate und Workshops zusätzlich an wechselnden Orten – etwa in der Prana Oase in Alland oder bei Wakanda Health in Innermanzing. Den genauen Ort erfährst du bei der Terminvereinbarung.',
    },
    {
  ...
  events: [
    {
      ...
      desc: 'Du gehst deinen ganz eigenen Weg und bist gleichzeitig getragen von der Energie der Gruppe. Du darfst fühlen, loslassen, auftanken und für einen Moment aus dem ständigen Funktionieren aussteigen.',
      location: 'Prana Oase, Am Weißen Weg 182, 2534 Alland',
      seats: 'noch 2 Plätze',
      price: '69 €',
    },
    {
      ...
      title: 'Breathwork Journey',
      desc: 'Du gehst deinen ganz eigenen Weg und bist gleichzeitig getragen von der Energie der Gruppe. Du darfst fühlen, loslassen, auftanken und für einen Moment aus dem ständigen Funktionieren aussteigen.',
      location: 'Wakanda Health, Gewerbepark Süd 5, 3052 Innermanzing',
      seats: '14 Plätze',
      price: '69 €',
    },
    {
    ...
    },
    {
      ...
      title: 'Community Circle mit Kakao – Frauenkreis',
      desc: 'Ein geschützter Kreis für Austausch, Stille und echte Verbindung unter Frauen.',
      location: '3052 Innermanzing',
      seats: '8 Plätze',
      price: '39 €',
    },
    {
      date: '27. Februar 2027',
      ...
      location: 'Familienbundzentrum Reiser 4, 4223 Katsdorf',
      seats: '14 Plätze',
